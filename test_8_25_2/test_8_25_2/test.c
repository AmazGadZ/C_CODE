...
int main()
{
	...
	//printf("%d\n", sizeof(a + 1));//4/8 - 数组名这里表示首元素地址，a+1 是第2个元素地址，地址的大小就是4/8个字节
	...
	//printf("%d\n", sizeof(&a + 1));//4/8 - &a是数组的地址，&a+1 虽然地址跳过整个数组，但还是地址，所以是4/8个字节
	...
	//printf("%d\n", sizeof(arr + 0));//4/8 - arr是首元素地址，arr+0 还是首元素的地址，地址的大小是4/8字节
